...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Human father = new Human("Vito", "Karleone", 1950,90, new String[][]{{"Monday","Tuesday"},{"Work","Training"}});
        Human mother = new Human("Jane", "Karleone", 1955,85, new String[][]{{"Monday","Tuesday"},{"Playing","Walking"}});
